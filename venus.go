...
func newVenusAdapter() Adapter {
	...
	deployments := map[ChainID]venusDeployment{
		...
		Optimism: {
			PoolRegistry:       common.HexToAddress("0x147780799840d541c1d7c998f0cba996d11d62bb"),
			PoolRegistryWindow: availableFrom(126_048_098),
			PoolLens:           common.HexToAddress("0x142160a2e699e33af337741f157d96aad6bc72aa"),
			PoolLensWindow:     availableFrom(126_660_792),
			WrappedNative:      token(Optimism, "0x4200000000000000000000000000000000000006", "ETH", 18),
		},
	}
	return &VenusAdapter{
		adapterBase: adapterBase{info: ProtocolInfo{
			ID: "venus", Name: "Venus", Chains: deploymentChains(deployments),
		}},
